            ...
            <NavLink href="/portfolio">
                <a>
                    <svg id="projects-link-icon" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"
                         focusable="false"
                         data-prefix="far"
                         data-icon="eye" className="svg-inline--fa fa-eye fa-w-18" role="img" viewBox="0 0 576 512">
                        <clipPath id="projects-icon">
                            <path fill="currentColor"
            ...
            <NavLink href="/contact">
                <a>
                    <svg id="contact-link-icon" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"
                         focusable="false"
                         data-prefix="far"
                         data-icon="paper-plane" className="svg-inline--fa fa-paper-plane fa-w-16" role="img"
                         viewBox="0 0 512 512">
